...
def run(username: str,                         # CIS username
        ...
        # Added a couple of input parameters instead of hardcoding values.  2/15/22
        ITYPE  : int = 2,
        IMULT  : int = -1,
        IM     : int = 0,
        ISUN   : int = 10,
    ...
    card1a = np.array([
        ...
        [ISUN,       'ISUN',      int,      4,       ISUN == 10 or ISUN == 0],
    ...
    card3a1 = np.array([
        #VARIABLE      NAME       TYPE      SIZE      CONDITION
        [IPARM,       'IPARM',    int,      5,       IPARM in [2, 12]], # added 2 for sample tape5
    ...
    print(num_data_lines, num_columns)
